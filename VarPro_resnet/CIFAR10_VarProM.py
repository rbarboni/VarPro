...
parser.add_argument('--momentum', '-m', type=float, default=0.9) ## Momentum
...
print('Optimizer = VarPro with Momentum')
...
if args.name is not None:
    ...
    path = f'VarProM_lmbda{np.log10(args.lmbda):.1f}_bs{args.batch_size}_ts{np.log10(args.time_scale):.1f}.pkl.gz'
...
criterion = VarProCriterion(lmbda=lmbda, num_classes=10, momentum=0.5)
...
assert problem.criterion.projection.momentum is not None

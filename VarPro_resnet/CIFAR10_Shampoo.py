...
## Default arguments
parser.add_argument('--lmbda', '-l', type=float, default=1e-2)  ## Regularization parameter
...
if args.name is not None:
    ...
    path = f'Shampoo_lmbda{np.log10(args.lmbda):.1f}_bs{args.batch_size}_ts{np.log10(args.time_scale):.1f}.pkl.gz'
...
## Training
# Shampoo: every parameter is trained with the same learning rate
optimizer = torch_optimizer.Shampoo(resnet.parameters(), lr=lr)
